...
public class MusicFieldClearerTest {
  ...
  public void testClearOutUnwantedFieldsID3v1() {
    ...
    MusicFieldClearer.clearOutUnwantedFields(id3v2Tag);
  ...
  public void testUnwantedFieldsArePopulatedListOfMp3File() {
    ...
    MusicFieldClearer.unwantedFieldsArePopulated(mp3Files);
  ...
  public void testUnwantedFieldsArePopulatedTrue1() {
    ...
    assertTrue(MusicFieldClearer.unwantedFieldsArePopulated(id3v2Tag));
  }
  ...
  public void testUnwantedFieldsArePopulatedFalse() {
    ...
    assertFalse(MusicFieldClearer.unwantedFieldsArePopulated(id3v2Tag));
  }

  @Test
  public void testCheckIfPopulatedStringString() {
    assertTrue(MusicFieldClearer.checkIfPopulated("Dummy boolean field", "Field"));
    assertFalse(MusicFieldClearer.checkIfPopulated("Dummy boolean field", null));
    assertFalse(MusicFieldClearer.checkIfPopulated("Dummy boolean field", ""));
    assertFalse(MusicFieldClearer.checkIfPopulated("Dummy boolean field", "     "));
  }

  @Test
  public void testCheckIfPopulatedStringBoolean() {
    assertTrue(MusicFieldClearer.checkIfTrue("Dummy boolean field", true));
    assertFalse(MusicFieldClearer.checkIfTrue("Dummy boolean field", false));
  }
